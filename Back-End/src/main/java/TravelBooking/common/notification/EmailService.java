package TravelBooking.common.notification; // 👈 Đảm bảo dòng này giống tên package của bạn
...
public class EmailService {
    ...
    // Hàm gửi email HTML
    @Async
    public void sendHtmlEmail(String to, String subject, String name, String tourName, String date, int guestSize,
            double price, long bookingId) {
        try {
