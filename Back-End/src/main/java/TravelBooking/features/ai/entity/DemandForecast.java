package TravelBooking.features.ai.entity;
...
public class DemandForecast {
    ...
    public Integer getPredictedPassengers() {
        return predictedPassengers;
    }

    public void setPredictedPassengers(Integer predictedPassengers) {
        this.predictedPassengers = predictedPassengers;
    }
